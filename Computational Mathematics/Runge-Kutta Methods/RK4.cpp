...
int main() {
    ...
    for (double step : step_choice) {
        auto integrated_cubicTimeRHS = integrate<RK4Table, CubicTime>(initialState_cubicTimeRHS, endTime_cubicTimeRHS, step, cubicTimeRHS);       
        auto integrated_harmonicRHS = integrate<RK4Table, Harmonic>(initialState_harmonicRHS, endTime_harmonicRHS, step, harmonicRHS);
