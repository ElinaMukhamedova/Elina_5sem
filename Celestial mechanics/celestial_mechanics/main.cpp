...
int main() {
    ...
    std::cout << "tt.jdInt() = " << std::setprecision(15) <<  tt.jdInt() << std::endl;
    std::cout << "tt.jdFrac() = " << std::setprecision(15) <<  tt.jdFrac() << std::endl;
    
    const auto utc = coordinatesConverter.timeConverter().convert<Scale::UTC>(tt);
    std::cout << "utc.jdInt() = " << std::setprecision(15) <<  utc.jdInt() << std::endl;
    std::cout << "utc.jdFrac() = " << std::setprecision(15) <<  utc.jdFrac() << std::endl;

    const auto ut1 = coordinatesConverter.timeConverter().convert<Scale::UT1>(tt);
    std::cout << "ut1.jdInt() = " << std::setprecision(15) <<  ut1.jdInt() << std::endl;
    std::cout << "ut1.jdFrac() = " << std::setprecision(15) <<  ut1.jdFrac() << std::endl;

    std::cout << std::setprecision(15) << "dX = " << EOPcontainer.dX(utc.mjd()) << std::endl;
    std::cout << std::setprecision(15) << "dY = " << EOPcontainer.dY(utc.mjd()) << std::endl;
    std::cout << std::setprecision(15) << "xp = " << EOPcontainer.xTerr(utc.mjd()) << std::endl;
    std::cout << std::setprecision(15) << "yp = " << EOPcontainer.yTerr(utc.mjd()) << std::endl;
    ...
    std::cout << std::setprecision(15) << gcrs2cirs << std::endl;
    ...
    std::cout << std::setprecision(15) << cirs2tirs << std::endl;
    ...
    std::cout << std::setprecision(15) << tirs2itrs << std::endl;
