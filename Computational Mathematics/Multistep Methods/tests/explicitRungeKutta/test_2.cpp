...
TEST(rhsTest, CubicTimeWorks){
    ...
    CubicTime0::StateAndArg stateAndArg_13{Eigen::Vector<double, 1>{13}, 0.7};
    CubicTime0::StateAndArg stateAndArg_17{Eigen::Vector<double, 1>{17}, 0.3};
...
TEST(rhsTest, HarmonicWorks) {
    ...
    Harmonic0::StateAndArg stateAndArg_1{Eigen::Vector<double, 2>{13, 17}, 0.7};
    Harmonic0::StateAndArg stateAndArg_2{Eigen::Vector<double, 2>{21, 13}, 0.3};
