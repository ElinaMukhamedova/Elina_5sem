...
#include "celestial_mechanics/forces/Evig.hpp"
...
TEST_F(SolarRadiationPressureTest, EvigWorks) {
    ...
    Eigen::Vector3d EarthMoon = evig.vector<Himmellegeme::Jorden, Himmellegeme::Månen>(tdb);
    ...
    Eigen::Vector3d SunMars = evig.vector<Himmellegeme::Sola, Himmellegeme::Mars>(tdb);
